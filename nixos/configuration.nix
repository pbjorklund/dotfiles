...

{
  ...
  services.displayManager.autoLogin.user = "pbjorklund";
  ...
  programs._1password-gui = {
    ...
    polkitPolicyOwners = [ "pbjorklund" ];
  };

  services.xserver.xkb.options = "ctrl:nocaps";

  # Hardware support for ThinkPad
  services.thinkfan.enable = true; # Fan control for ThinkPads
  services.fprintd.enable = true;  # Fingerprint reader (if your model has one)

  # Enable Bluetooth
  hardware.bluetooth.enable = true;

  # Trackpoint and touchpad tweaks (optional, adjust as preferred)
  services.xserver.libinput.enable = true;
  services.xserver.libinput.touchpad.naturalScrolling = true;

  # Fonts (makes UI look better)
